...
export default function Home() {
  ...
  return (
    <div className="w-screen min-h-screen" style={{ backgroundColor: 'rgba(255, 0, 0, 0' }}>
      ...
      <div className="grid h-screen grid-cols-1 lg:grid-cols-12">
        ...
        <img src="https://d391b93f5f62d9c15f67142e43841acc.ipfscdn.io/ipfs/bafybeihsgn6vi3uybmnivdr2red3ues4fmuzzrnvr7wax67vjv436avnwm/gif.gif"/>
